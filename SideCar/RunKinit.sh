...
[[ -e /krb5/krb5.keytab ]] && OPTIONS="-k" && echo "*** using host keytab"
 [[ -e /krb5/dbuser.keytab ]] && OPTIONS="-k -i" && echo "*** using client keytab"
...
echo "*** Warning default keytab (/krb5/krb5.keytab) or default client keytab (/krb5/dbuser.keytab) not found"
